  ...
  return (
    <div className="mx-auto max-w-6xl pb-12">
      <div className="mb-8">
        ...
        <p className="text-muted text-sm mt-1">Connect securely to private networks and resources.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <div className="rounded-xl border border-border bg-surface/20 p-5">
          ...
          <p className="text-sm text-muted">Get a comprehensive view of your connect configuration and status.</p>
        </div>
        <div className="rounded-xl border border-border bg-surface/20 p-5">
          ...
          <p className="text-sm text-muted">Configure settings, rules, and preferences for your connect.</p>
        </div>
        <div className="rounded-xl border border-border bg-surface/20 p-5">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-amber-500/10 mb-3">
            <Cable className="h-5 w-5 text-amber-500" />
          </div>
      ...
      <div className="flex flex-col items-center justify-center py-20 border border-border bg-surface/30 rounded-2xl">
        ...
        <h2 className="text-xl font-semibold text-text mb-2">Connect is coming soon</h2>
        <p className="text-muted text-sm max-w-md text-center mb-8">
          We are working on secure tunnels, private network access, and VPN-less connections. Check back soon or read our documentation to learn more.
        </p>
