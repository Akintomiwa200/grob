  ...
  return (
    <div className="max-w-6xl mx-auto py-10 px-4 md:px-6">
      <div className="mb-8">
        ...
        <p className="text-muted text-sm mt-2">Manage all of your deployments across projects.</p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-20 border border-border bg-surface/30 rounded-2xl shadow-sm">
        ...
        <h2 className="text-xl font-semibold text-text mb-2">Deployments is coming soon</h2>
