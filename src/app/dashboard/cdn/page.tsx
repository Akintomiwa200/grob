...
export default async function EdgeNetworkPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl pb-12">
      <div className="mb-8">
        ...
        <p className="text-muted text-sm mt-1">Global edge caching and CDN configuration.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <div className="rounded-xl border border-border bg-surface/20 p-5">
          ...
          <p className="text-sm text-muted">Get a comprehensive view of your edge network configuration and status.</p>
        </div>
        <div className="rounded-xl border border-border bg-surface/20 p-5">
          ...
          <p className="text-sm text-muted">Configure settings, rules, and preferences for your edge network.</p>
        </div>
        <div className="rounded-xl border border-border bg-surface/20 p-5">
      ...
      <div className="flex flex-col items-center justify-center py-20 border border-border bg-surface/30 rounded-2xl">
        ...
        <p className="text-muted text-sm max-w-md text-center mb-8">
          We are working on fast content delivery through our global edge network with cache controls. Check back soon or read our documentation to learn more.
        </p>
