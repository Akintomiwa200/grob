  ...
  return (
    <div className="mx-auto max-w-6xl pb-12">
      <div className="mb-8">
        ...
        <p className="text-muted text-sm mt-1">Route, cache, and monitor AI API requests.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <div className="rounded-xl border border-border bg-surface/20 p-5">
          ...
          <p className="text-sm text-muted">Get a comprehensive view of your ai gateway configuration and status.</p>
        </div>
        <div className="rounded-xl border border-border bg-surface/20 p-5">
          ...
          <p className="text-sm text-muted">Configure settings, rules, and preferences for your ai gateway.</p>
        </div>
        <div className="rounded-xl border border-border bg-surface/20 p-5">
      ...
      <div className="flex flex-col items-center justify-center py-20 border border-border bg-surface/30 rounded-2xl">
        ...
        <h2 className="text-xl font-semibold text-text mb-2">AI Gateway is coming soon</h2>
        <p className="text-muted text-sm max-w-md text-center mb-8">
          We are working on intelligent routing, caching, and rate limiting for your AI API calls. Check back soon or read our documentation to learn more.
        </p>
