  ...
  return (
    <div className="min-h-screen bg-bg font-[Inter,sans-serif] text-text pb-24">
      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pt-10">
        ...
        >
          <div className="inline-flex items-center rounded-full border border-border bg-[#0B0E14] px-4 py-1.5 text-xs font-semibold tracking-wider text-text uppercase mb-8 shadow-sm">
            Contact Us
          </div>
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full rounded-2xl border border-border bg-[#0B0E14] py-3.5 pl-11 pr-4 text-sm text-text placeholder-muted/60 focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent transition-all"
                    />
                  </div>
                </div>
              ...
              <div className="space-y-2 relative">
                ...
                <textarea 
                  ...
                  rows={5}
                  className="w-full rounded-2xl border border-border bg-[#0B0E14] p-4 text-sm text-text placeholder-muted/60 focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent transition-all resize-none"
                />
          ...
          >
            <div className="space-y-8 flex-1">
              ...
              <div className="flex gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-border bg-[#0B0E14]">
            ...
            {/* Status Indicator */}
            <div className="mt-10 mb-8 inline-flex items-center gap-2 rounded-full border border-border/50 bg-[#0B0E14] px-3 py-1.5 self-start shadow-sm">
            ...
            <div className="flex gap-3 mt-6">
              <a href="#" className="flex h-12 w-12 items-center justify-center rounded-2xl border border-border bg-[#0B0E14] text-muted hover:text-text hover:bg-border/50 transition-colors">
